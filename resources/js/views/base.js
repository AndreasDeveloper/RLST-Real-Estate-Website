...
export const DOMElements = {
    ...
    sliderBg: document.querySelector('.slide__bg'),
    sliderPagination: document.querySelector('.slider-pagi'),
    sliderPaginationEl: document.querySelector('.slider-pagi__elem'),
